...
> 个人资料第一版只做头像和昵称。新用户默认昵称为“哈基米 + 6 个随机英文字母”，默认展示系统头像；用户可自行修改头像和昵称，这些修改只影响展示，不影响 Hermes 配对和智能体使用。
